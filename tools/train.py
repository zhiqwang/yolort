...
PATH_V5 = str(ROOT) + "/yolort/yolo5"
print(PATH_V5)
if str(PATH_V5) not in sys.path:
    sys.path[1] = str(PATH_V5)  # add PATH_V5 to PATH
    sys.path[0] = str(ROOT)
...
from yolort.v5.utils.autobatch import check_train_batch_size
...
from yolort.v5.utils.general import (LOGGER, check_dataset, check_file, check_git_status, check_img_size, check_requirements,
...
from yolort.v5.utils.torch_utils import EarlyStopping, ModelEMA, de_parallel, select_device, torch_distributed_zero_first
...
def parse_opt(known=False):
    ...
    parser.add_argument('--hyp', type=str, default= '../yolort/v5/data/hyps/hyp.scratch.yaml', help='hyperparameters path')
