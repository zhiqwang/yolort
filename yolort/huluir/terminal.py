# Copyright (c) 2022, Apache Software Foundation (ASF). All rights reserved.
#
# This source code is licensed under the Apache-2.0 license found in the
# LICENSE file in the root directory of TVM OSS project.
#
...
from .interface import DefaultVizParser, Plotter, VizEdge, VizGraph, VizNode, VizParser
    ...
    def render(self) -> str:
        ...
        def gen_line(indent, n_id):
            ...
            for i, next_n_id in enumerate(self._graph[n_id]):
                ...
                lines.append(f"{indent}{conn_symbol[1 if i==last else 0]}{node.type} {node.other_info}")
                next_indent = indent
